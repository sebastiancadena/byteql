...
export type ParserName = 'dns_packet' | 'dns_tcp_message' | 'ethernet_frame' | 'icmp_packet' | 'icmpv6_packet' | 'ipv4_packet' | 'ipv6_packet' | 'tcp_segment' | 'tls_client_hello' | 'udp_datagram';
