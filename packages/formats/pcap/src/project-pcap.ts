...
export const pcapNullability: Readonly<Record<string, ReadonlySet<string>>> = {
  ...
  dns: new Set(['_src_start', '_src_end', 'query_name', 'query_type', 'stream_id', '_src_ranges']),
  icmp: new Set(['_src_start', '_src_end', 'echo_id', 'echo_seq']),
  icmpv6: new Set(['_src_start', '_src_end', 'echo_id', 'echo_seq']),
  tls: new Set(['_src_start', '_src_end', 'sni', 'stream_id', '_src_ranges']),
  streams: new Set(['_src_start', '_src_end', '_src_ranges']),
