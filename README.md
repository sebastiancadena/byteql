...
| `packages/formats/pcap` | `@byteql/pcap` | Network capture pack: classic pcap and pcapng containers, 10-parser dissect chain (ethernet → ipv4/ipv6 → tcp/udp → dns/icmp/icmpv6/tls) with TCP stream reassembly.                                                                                                        |
